...
export default function Hero() {
  return (
    /* Updated max-w-6xl for consistency with About/Skills */
    <section id="home" className="relative pt-32 pb-20 px-6 md:px-12 max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12 min-h-[90vh] overflow-hidden">
      ...
      <div className="flex-1 text-left space-y-6 animate-in fade-in slide-in-from-left-10 duration-1000">
        ...
        <div className="text-xl md:text-2xl font-semibold text-slate-700 h-12 flex items-center">
            ...
            <span className="min-w-[260px] text-slate-500">
                <Typewriter
                options={{
                    strings: ['Problem Solver', 'Machine Learning Enthusiast', 'Full Stack Developer'],
                    autoStart: true,
                    loop: true,
                    deleteSpeed: 50,
                }}
        ...
        <div className="space-y-6 pt-4">
            {/* Changed: flex-nowrap on mobile to force same line. 
               Used gap-3 for mobile to save space. 
            */}
            <div className="flex flex-nowrap items-center gap-3 md:gap-6">
                <a 
                    href="#projects"
                    /* Reduced px-4 on mobile (md:px-8) to ensure they fit side-by-side */
                    className="flex-1 md:flex-none text-center px-4 md:px-8 py-3.5 bg-[#2563eb] text-white rounded-xl font-bold text-sm md:text-lg shadow-xl shadow-blue-200 hover:-translate-y-2 hover:shadow-blue-300 transition-all duration-300 active:scale-95"
                    >
                    View Projects
                </a>
            ...
            <div className="flex flex-wrap items-center gap-3 md:gap-4">
                <a 
                    ...
                    download
                    className="flex items-center gap-2 px-4 md:px-5 py-2.5 bg-white border border-slate-200 rounded-xl text-slate-700 font-bold text-xs md:text-sm shadow-sm hover:bg-slate-50 hover:border-blue-300 hover:text-blue-600 hover:-translate-y-1 transition-all duration-300 active:scale-95"
                >
                    <Download size={16} />
                    Resume
                </a>
                ...
                <div className="flex items-center gap-2 md:gap-4">
                    {/* GitHub */}
                    <a href="https://github.com/panditsurendra?tab=repositories" target="_blank" rel="noopener noreferrer" className="p-2.5 md:p-3 bg-white border border-slate-100 rounded-xl text-slate-700 shadow-sm hover:text-blue-600 hover:border-blue-200 hover:-translate-y-1 transition-all duration-300" title="GitHub">
                        <Github size={20} className="md:w-6 md:h-6" />
                    </a>

                    {/* LinkedIn */}
                    <a href="https://www.linkedin.com/in/surendra-kumar-pandit-9b806b2b3/" target="_blank" rel="noopener noreferrer" className="p-2.5 md:p-3 bg-white border border-slate-100 rounded-xl text-slate-700 shadow-sm hover:text-[#0077b5] hover:border-blue-200 hover:-translate-y-1 transition-all duration-300" title="LinkedIn">
                        <Linkedin size={20} className="md:w-6 md:h-6" />
                    </a>

                    {/* LeetCode */}
                    <a href="https://codolio.com/profile/panditSurendra" target="_blank" rel="noopener noreferrer" className="p-2.5 md:p-3 bg-white border border-slate-100 rounded-xl text-slate-700 shadow-sm hover:text-[#ffa116] hover:border-orange-200 hover:-translate-y-1 transition-all duration-300" title="LeetCode">
      ...
      <div className="flex-1 flex justify-center items-center animate-in fade-in zoom-in duration-1000 delay-300">
          <div className="relative w-72 h-72 md:w-[420px] md:h-[420px]">
              ...
              <div className="relative glass p-3 rounded-[2.5rem] border-white/40 shadow-xl cursor-pointer transition-all duration-500 ease-out hover:scale-105 hover:shadow-[0_0_60px_20px_rgba(59,130,246,0.5)] hover:border-blue-300/50">
                  <img src="/profile.jpg" alt="Surendra Kumar Pandit" className="w-full h-full object-cover rounded-[2rem]" />
              </div>
          </div>
      </div>
    </section>
